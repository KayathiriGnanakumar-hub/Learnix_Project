...
export default function CourseDetails() {
  ...
  useEffect(() => {
    if (selectedVideo) {
      setVideoCompleted(watchedVideos[selectedVideo.id] || false);
    }
  ...
  const handleVideoComplete = (videoId) => {
    setWatchedVideos({ ...watchedVideos, [videoId]: true });
              ...
              {isEnrolled ? (
                ...
                <div className="bg-white border border-slate-200 rounded-xl shadow-md p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-bold py-3 px-6 rounded-lg transition-all shadow-md hover:shadow-lg mb-3"
                  >
                    Enroll Now
                  </button>
                  <button className="w-full border border-slate-300 text-slate-900 font-semibold py-2 px-6 rounded-lg hover:bg-slate-50 transition-all">
                    Add to Wishlist
                  </button>
                </div>
              )}
              ...
              <div className="space-y-8">
                ...
                {selectedVideo && selectedVideo.youtube_url ? (
                  <div className="bg-white rounded-xl shadow-md overflow-hidden border border-slate-200">
                    ...
                    <div className="p-8">
                      <div className="mb-6">
                        <p className="text-sm text-teal-600 font-semibold mb-2 flex items-center gap-2">
                      ...
                      {isEnrolled && (
                        <div>
                          <button
                            ...
                            className={`inline-flex items-center gap-2 font-bold py-3 px-6 rounded-lg transition-all ${
                              watchedVideos[selectedVideo.id]
                                ? "bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white shadow-md hover:shadow-lg cursor-pointer"
            ...
            {activeTab === "instructor" && (
              <div className="bg-white rounded-xl shadow-md p-8 border border-slate-200">
                ...
                <div className="flex items-start gap-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-teal-600 font-semibold mb-4">Professional Instructor</p>
                    <p className="text-slate-700 leading-relaxed mb-4">
